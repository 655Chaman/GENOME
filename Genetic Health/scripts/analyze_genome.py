    ...
    with open(output_path, 'w') as f:
        ...
        if high_impact:
            for finding in high_impact:
                ...
                f.write(f"**🧬 Search Terms:** {finding['gene']}, {finding['rsid']}, {finding['category']}, {finding['status']}\n")
        ...
        for category, findings in sorted(categories.items()):
            ...
            for finding in findings:
                ...
                f.write(f"| {finding['gene']} | {finding['genotype']} | {finding['status']} | {desc} |\n")
            f.write("\n")
        ...
        if results['pharmgkb_findings']:
            for finding in results['pharmgkb_findings'][:30]:  # Top 30
                ...
                f.write(f"- **What this means**: {finding['annotation']}\n\n")
        else:
