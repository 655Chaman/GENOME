...
Based on your genetics, your body has specific deficiencies in processing certain nutrients. We have separated these into two categories: Clinical Supplements (when you need a concentrated dose to bypass a genetic block) and Science-Backed Natural/Ayurvedic Sources.
...
\"\"\"
    ...
    if 'PEMT' in findings_dict:
        ...
        natural_report += "  * **Ayurvedic/Herbal:** Kutki (Picrorhiza kurroa) or Milk Thistle to support your liver's fat-processing capabilities, which are strained by the PEMT gene.\\n\\n"
